...
def test_apple_shop_search(navigate_to_main_page, env):
    apple_store_name = env.store_name
    retail_page = navigate_to_main_page.store_click()
...
@pytest.mark.smoke
@pytest.mark.regression
def test_apple_wallet(navigate_to_main_page):
    apple_wallet_page = navigate_to_main_page.go_to_wallet()
